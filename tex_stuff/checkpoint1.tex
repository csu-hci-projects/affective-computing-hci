...
\title{Does humans develop a same emotion toward virtual entities?}
...
\author{Farhan Haziq\thanks{e-mail: farhan.farhan@rams.colostate.edu}\\ %
        \scriptsize Colorado State University, Fort Collins, Colorado }
